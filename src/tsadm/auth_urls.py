...
urlpatterns = [
    ...
    url(r'^password_change/$', auth_views.password_change,
        {'template_name': tmplPath('tsadm/password_change_form.html')},
        name='password_change'),
    url(r'^password_change/done/$', auth_views.password_change_done,
        {'template_name': tmplPath('tsadm/password_change_done.html')},
    ...
    url(r'^password_reset/done/$', auth_views.password_reset_done,
        {'template_name': tmplPath('tsadm/password_reset_done.html')},
        name='password_reset_done'),

    # reset confirm
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', auth_views.password_reset_confirm,
        {'template_name': tmplPath('tsadm/password_reset_confirm.html')},
        name='password_reset_confirm'),
    url(r'^reset/done/$', auth_views.password_reset_complete,
        {'template_name': tmplPath('tsadm/password_reset_complete.html')}, name='password_reset_complete'),
]
